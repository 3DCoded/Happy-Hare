Page Index
- [<sub>Wiring</sub>](#---wiring)
- [<sub>Hardware Config</sub>](#---hardware-config)
- [<sub>Controlling LED Effects</sub>](#---controlling-led-effects)
- [<sub>Summary of Default Effects</sub>](#---summary-of-default-effects)
