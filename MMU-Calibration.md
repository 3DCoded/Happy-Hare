...
graph TD;
    ...
    MMU_SERVO --> MMU_CALIBRATE_GEAR(S)
    MMU_CALIBRATE_GEAR(S) --> MMU_CALIBRATE_ENCODER
    MMU_CALIBRATE_ENCODER --> MMU_CALIBRATE_BOWDEN(S)
    MMU_CALIBRATE_BOWDEN(S) --> MMU_CALIBRATE_GATES
